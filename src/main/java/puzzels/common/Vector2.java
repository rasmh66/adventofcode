...
public class Vector2 {
    ...
    /**
     * Subtracts the right operand vector to the left operand vector, applying absolute value to the result.
     *
     * <p>
     ...
     *
     * </p>
     * @param other subtracting Vector2.
     */
    public void subtractAbs(Vector2 other) {
     ...
     */
    public static Vector2 subtractAbs(Vector2 leftOperand, Vector2 rightOperand) {
